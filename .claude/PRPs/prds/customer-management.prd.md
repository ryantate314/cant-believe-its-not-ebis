...
| 2 | Database & API - Relationships | Aircraft-customer join table, relationship endpoints, work order auto-link on creation, tests | pending | - | 1 | - |
| 3 | Frontend - Customer List & Detail | Customer list page, detail/edit page, API client, Next.js proxy routes, frontend tests | pending | - | 1 | - |
